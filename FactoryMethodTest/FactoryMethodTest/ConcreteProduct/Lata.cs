...
{
    public class Lata : Refrigerante
    {
        ...
        public Lata(string tamanhoRecipiente, string saborRefrigerante, int quantidadeRefrigerante, int _valorRefrigerante)
        {
            this._tipoRecipiente = "Lata"; // tamanho e sabor receberão os valores do construtor
